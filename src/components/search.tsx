const ResponsiveSearchBar = () => {
  return (
    <label
      className="mx-auto my-20 w-[90%] md:w-[85%] relative bg-white  flex flex-col md:flex-row items-center justify-center border py-2 px-2 md:rounded-1xl rounded-3xl gap-2 shadow-2xl focus-within:border-gray-300"
      htmlFor="search-bar"
    >
      <input
        id="search-bar"
